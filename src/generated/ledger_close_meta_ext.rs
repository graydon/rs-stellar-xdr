...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`LedgerCloseMetaExt`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyLedgerCloseMetaExt(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyLedgerCloseMetaExt {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyLedgerCloseMetaExt {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyLedgerCloseMetaExt {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            ...
            1 => {
                let field_len = <LazyLedgerCloseMetaExtV1 as LazyXdr>::xdr_validate(
                    &buf[pos as usize..],
                    depth,
                )?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            ...
            1 => {
                pos += <LazyLedgerCloseMetaExtV1 as LazyXdr>::xdr_len(&buf[pos as usize..]);
            }
            _ => {}
        }
        pos
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyLedgerCloseMetaExt {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyLedgerCloseMetaExt {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyLedgerCloseMetaExt {
    type Error = Error;
...
impl LazyLedgerCloseMetaExt {
    ...
    #[must_use]
    pub fn as_v1(&self) -> Option<LazyLedgerCloseMetaExtV1> {
        if self.discriminant_i32() == 1 {
            Some(<LazyLedgerCloseMetaExtV1 as LazyXdr>::from_xdr_at(
                &self.0, 4,
            ))
        } else {
            None
...
impl TryFrom<&LedgerCloseMetaExt> for LazyLedgerCloseMetaExt {
    type Error = Error;
    fn try_from(val: &LedgerCloseMetaExt) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyLedgerCloseMetaExt> for LedgerCloseMetaExt {
    type Error = Error;
    fn try_from(lazy: &LazyLedgerCloseMetaExt) -> Result<Self, Error> {
