...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TransactionHistoryEntry`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTransactionHistoryEntry(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTransactionHistoryEntry {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTransactionHistoryEntry {
...
impl LazyXdr for LazyTransactionHistoryEntry {
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        pos += <LazyTransactionHistoryEntryExt as LazyXdr>::xdr_len(&buf[pos as usize..]);
        pos
    }
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTransactionHistoryEntry {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTransactionHistoryEntry {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTransactionHistoryEntry {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyTransactionHistoryEntry {
...
impl TryFrom<&TransactionHistoryEntry> for LazyTransactionHistoryEntry {
    type Error = Error;
    fn try_from(val: &TransactionHistoryEntry) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTransactionHistoryEntry> for TransactionHistoryEntry {
    type Error = Error;
    fn try_from(lazy: &LazyTransactionHistoryEntry) -> Result<Self, Error> {
