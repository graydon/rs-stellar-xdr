...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TransactionV1Envelope`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTransactionV1Envelope(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTransactionV1Envelope {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTransactionV1Envelope {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTransactionV1Envelope {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTransactionV1Envelope {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTransactionV1Envelope {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyTransactionV1Envelope {
    /// Access field `tx`.
    #[must_use]
...
impl TryFrom<&TransactionV1Envelope> for LazyTransactionV1Envelope {
    type Error = Error;
    fn try_from(val: &TransactionV1Envelope) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTransactionV1Envelope> for TransactionV1Envelope {
    type Error = Error;
    fn try_from(lazy: &LazyTransactionV1Envelope) -> Result<Self, Error> {
