...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`ScSpecFunctionInputV0`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyScSpecFunctionInputV0(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyScSpecFunctionInputV0 {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyScSpecFunctionInputV0 {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyScSpecFunctionInputV0 {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyScSpecFunctionInputV0 {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyScSpecFunctionInputV0 {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyScSpecFunctionInputV0 {
    /// Access field `doc`.
    #[must_use]
...
impl TryFrom<&ScSpecFunctionInputV0> for LazyScSpecFunctionInputV0 {
    type Error = Error;
    fn try_from(val: &ScSpecFunctionInputV0) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyScSpecFunctionInputV0> for ScSpecFunctionInputV0 {
    type Error = Error;
    fn try_from(lazy: &LazyScSpecFunctionInputV0) -> Result<Self, Error> {
