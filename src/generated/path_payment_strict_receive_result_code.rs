...
impl LazyXdr for PathPaymentStrictReceiveResultCode {
    ...
    fn xdr_validate(buf: &[u8], _depth: u32) -> Result<u32, Error> {
        ...
        let _ = PathPaymentStrictReceiveResultCode::try_from(v)?;
        Ok(4)
    }
    ...
    fn from_xdr_consume(_parent: &LazyHandle, buf: &mut &[u8]) -> Self {
        ...
        *buf = &buf[4..];
        ...
        PathPaymentStrictReceiveResultCode::try_from(v).unwrap()
    }
}
