...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TrustLineEntryV1`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTrustLineEntryV1(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTrustLineEntryV1 {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTrustLineEntryV1 {
...
impl LazyXdr for LazyTrustLineEntryV1 {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        {
            let field_len =
                <LazyTrustLineEntryV1Ext as LazyXdr>::xdr_validate(&buf[pos as usize..], depth)?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        let mut pos: u32 = 0;
        pos += 16;
        pos += <LazyTrustLineEntryV1Ext as LazyXdr>::xdr_len(&buf[pos as usize..]);
        pos
    }
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTrustLineEntryV1 {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTrustLineEntryV1 {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTrustLineEntryV1 {
    type Error = Error;
...
impl TryFrom<&TrustLineEntryV1> for LazyTrustLineEntryV1 {
    type Error = Error;
    fn try_from(val: &TrustLineEntryV1) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTrustLineEntryV1> for TrustLineEntryV1 {
    type Error = Error;
    fn try_from(lazy: &LazyTrustLineEntryV1) -> Result<Self, Error> {
