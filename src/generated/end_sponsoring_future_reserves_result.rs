...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`EndSponsoringFutureReservesResult`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyEndSponsoringFutureReservesResult(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyEndSponsoringFutureReservesResult {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyEndSponsoringFutureReservesResult {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyEndSponsoringFutureReservesResult {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyEndSponsoringFutureReservesResult {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyEndSponsoringFutureReservesResult {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyEndSponsoringFutureReservesResult {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyEndSponsoringFutureReservesResult {
    ...
    pub fn discriminant(&self) -> EndSponsoringFutureReservesResultCode {
        ...
        EndSponsoringFutureReservesResultCode::try_from(self.discriminant_i32()).unwrap()
    }
}
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&EndSponsoringFutureReservesResult> for LazyEndSponsoringFutureReservesResult {
    type Error = Error;
    fn try_from(val: &EndSponsoringFutureReservesResult) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyEndSponsoringFutureReservesResult> for EndSponsoringFutureReservesResult {
    type Error = Error;
    fn try_from(lazy: &LazyEndSponsoringFutureReservesResult) -> Result<Self, Error> {
