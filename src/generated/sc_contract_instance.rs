...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`ScContractInstance`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyScContractInstance(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyScContractInstance {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyScContractInstance {
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
        core::cmp::Ordering::Equal
            .then_with(|| self.executable().cmp(&other.executable()))
            .then_with(|| self.storage().cmp(&other.storage()))
    }
}
#[cfg(feature = "alloc")]
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyScContractInstance {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyScContractInstance {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyScContractInstance {
    type Error = Error;
...
impl LazyScContractInstance {
    ...
    #[must_use]
    pub fn storage(&self) -> LazyOption<LazyScMap> {
        let buf = self.0.as_slice();
        let mut pos: u32 = 0;
        pos += <LazyContractExecutable as LazyXdr>::xdr_len(&buf[pos as usize..]);
        <LazyOption<LazyScMap> as LazyXdr>::from_xdr_at(&self.0, pos)
    }
}
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&ScContractInstance> for LazyScContractInstance {
    type Error = Error;
    fn try_from(val: &ScContractInstance) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyScContractInstance> for ScContractInstance {
    type Error = Error;
    fn try_from(lazy: &LazyScContractInstance) -> Result<Self, Error> {
