...
#[cfg(feature = "alloc")]
// Enum ClaimableBalanceFlags: scalar lazy type — impl LazyXdr directly on the enum.
impl LazyXdr for ClaimableBalanceFlags {
    ...
    fn xdr_validate(buf: &[u8], _depth: u32) -> Result<u32, Error> {
        ...
        let _ = ClaimableBalanceFlags::try_from(v)?;
        Ok(4)
    }
    ...
    fn from_xdr_consume(_parent: &LazyHandle, buf: &mut &[u8]) -> Self {
        ...
        *buf = &buf[4..];
        ...
        ClaimableBalanceFlags::try_from(v).unwrap()
    }
}
