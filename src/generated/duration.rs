...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`Duration`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyDuration(u64);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyDuration {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyDuration {
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
        self.0.cmp(&other.0)
    }
}
#[cfg(feature = "alloc")]
impl LazyXdr for LazyDuration {
...
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyDuration {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl core::ops::Deref for LazyDuration {
    type Target = u64;
...
impl TryFrom<&Duration> for LazyDuration {
    type Error = Error;
    fn try_from(val: &Duration) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl From<&LazyDuration> for Duration {
    fn from(lazy: &LazyDuration) -> Self {
        Duration(**lazy)
    }
}
