...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TransactionSet`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTransactionSet(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTransactionSet {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTransactionSet {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTransactionSet {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTransactionSet {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTransactionSet {
    type Error = Error;
...
impl TryFrom<&TransactionSet> for LazyTransactionSet {
    type Error = Error;
    fn try_from(val: &TransactionSet) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTransactionSet> for TransactionSet {
    type Error = Error;
    fn try_from(lazy: &LazyTransactionSet) -> Result<Self, Error> {
