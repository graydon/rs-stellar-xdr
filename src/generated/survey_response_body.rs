...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`SurveyResponseBody`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazySurveyResponseBody(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazySurveyResponseBody {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazySurveyResponseBody {
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
        ...
        match self.discriminant_i32() {
            2 => self
                .as_survey_topology_response_v2()
                .cmp(&other.as_survey_topology_response_v2()),
            _ => core::cmp::Ordering::Equal,
        }
    }
}
#[cfg(feature = "alloc")]
impl LazyXdr for LazySurveyResponseBody {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            2 => {
                let field_len = <LazyTopologyResponseBodyV2 as LazyXdr>::xdr_validate(
                    &buf[pos as usize..],
                    depth,
                )?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            2 => {
                pos += <LazyTopologyResponseBodyV2 as LazyXdr>::xdr_len(&buf[pos as usize..]);
            }
            _ => {}
        }
        pos
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazySurveyResponseBody {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazySurveyResponseBody {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazySurveyResponseBody {
    type Error = Error;
...
impl LazySurveyResponseBody {
    ...
    #[must_use]
    pub fn discriminant(&self) -> SurveyMessageResponseType {
        // Validated — unwrap is safe.
        SurveyMessageResponseType::try_from(self.discriminant_i32()).unwrap()
    }
...
impl TryFrom<&SurveyResponseBody> for LazySurveyResponseBody {
    type Error = Error;
    fn try_from(val: &SurveyResponseBody) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazySurveyResponseBody> for SurveyResponseBody {
    type Error = Error;
    fn try_from(lazy: &LazySurveyResponseBody) -> Result<Self, Error> {
