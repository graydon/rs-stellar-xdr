...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`BucketMetadataExt`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyBucketMetadataExt(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyBucketMetadataExt {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyBucketMetadataExt {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyBucketMetadataExt {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            ...
            1 => {
                let field_len =
                    <BucketListType as LazyXdr>::xdr_validate(&buf[pos as usize..], depth)?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            ...
            1 => {
                pos += <BucketListType as LazyXdr>::xdr_len(&buf[pos as usize..]);
            }
            _ => {}
        }
        pos
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyBucketMetadataExt {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyBucketMetadataExt {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyBucketMetadataExt {
    type Error = Error;
...
impl LazyBucketMetadataExt {
    ...
    #[must_use]
    pub fn as_v1(&self) -> Option<BucketListType> {
        if self.discriminant_i32() == 1 {
            Some(<BucketListType as LazyXdr>::from_xdr_at(&self.0, 4))
        } else {
            None
        }
    }
...
impl TryFrom<&BucketMetadataExt> for LazyBucketMetadataExt {
    type Error = Error;
    fn try_from(val: &BucketMetadataExt) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyBucketMetadataExt> for BucketMetadataExt {
    type Error = Error;
    fn try_from(lazy: &LazyBucketMetadataExt) -> Result<Self, Error> {
