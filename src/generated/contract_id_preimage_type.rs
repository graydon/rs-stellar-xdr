...
#[cfg(feature = "alloc")]
// Enum ContractIdPreimageType: scalar lazy type — impl LazyXdr directly on the enum.
impl LazyXdr for ContractIdPreimageType {
    ...
    fn xdr_validate(buf: &[u8], _depth: u32) -> Result<u32, Error> {
        ...
        let _ = ContractIdPreimageType::try_from(v)?;
        Ok(4)
    }
    ...
    fn from_xdr_at(parent: &LazyHandle, offset: u32) -> Self {
        ...
        ContractIdPreimageType::try_from(v).unwrap()
    }
}
