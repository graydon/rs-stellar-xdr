...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`ManageSellOfferResult`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyManageSellOfferResult(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyManageSellOfferResult {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyManageSellOfferResult {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyManageSellOfferResult {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyManageSellOfferResult {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyManageSellOfferResult {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyManageSellOfferResult {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyManageSellOfferResult {
    ...
    pub fn discriminant(&self) -> ManageSellOfferResultCode {
        ...
        ManageSellOfferResultCode::try_from(self.discriminant_i32()).unwrap()
    }
...
impl TryFrom<&ManageSellOfferResult> for LazyManageSellOfferResult {
    type Error = Error;
    fn try_from(val: &ManageSellOfferResult) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyManageSellOfferResult> for ManageSellOfferResult {
    type Error = Error;
    fn try_from(lazy: &LazyManageSellOfferResult) -> Result<Self, Error> {
