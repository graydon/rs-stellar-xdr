...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`ClaimOfferAtom`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyClaimOfferAtom(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyClaimOfferAtom {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyClaimOfferAtom {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyClaimOfferAtom {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyClaimOfferAtom {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyClaimOfferAtom {
    type Error = Error;
...
impl TryFrom<&ClaimOfferAtom> for LazyClaimOfferAtom {
    type Error = Error;
    fn try_from(val: &ClaimOfferAtom) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyClaimOfferAtom> for ClaimOfferAtom {
    type Error = Error;
    fn try_from(lazy: &LazyClaimOfferAtom) -> Result<Self, Error> {
