...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TrustLineAsset`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTrustLineAsset(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTrustLineAsset {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTrustLineAsset {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyTrustLineAsset {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTrustLineAsset {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTrustLineAsset {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTrustLineAsset {
    type Error = Error;
...
impl TryFrom<&TrustLineAsset> for LazyTrustLineAsset {
    type Error = Error;
    fn try_from(val: &TrustLineAsset) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTrustLineAsset> for TrustLineAsset {
    type Error = Error;
    fn try_from(lazy: &LazyTrustLineAsset) -> Result<Self, Error> {
