...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`SorobanAddressCredentials`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazySorobanAddressCredentials(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazySorobanAddressCredentials {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazySorobanAddressCredentials {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazySorobanAddressCredentials {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazySorobanAddressCredentials {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazySorobanAddressCredentials {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazySorobanAddressCredentials {
...
impl TryFrom<&SorobanAddressCredentials> for LazySorobanAddressCredentials {
    type Error = Error;
    fn try_from(val: &SorobanAddressCredentials) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazySorobanAddressCredentials> for SorobanAddressCredentials {
    type Error = Error;
    fn try_from(lazy: &LazySorobanAddressCredentials) -> Result<Self, Error> {
