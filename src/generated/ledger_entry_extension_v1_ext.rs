...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`LedgerEntryExtensionV1Ext`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyLedgerEntryExtensionV1Ext(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyLedgerEntryExtensionV1Ext {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyLedgerEntryExtensionV1Ext {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyLedgerEntryExtensionV1Ext {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyLedgerEntryExtensionV1Ext {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyLedgerEntryExtensionV1Ext {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyLedgerEntryExtensionV1Ext {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyLedgerEntryExtensionV1Ext {
...
impl TryFrom<&LedgerEntryExtensionV1Ext> for LazyLedgerEntryExtensionV1Ext {
    type Error = Error;
    fn try_from(val: &LedgerEntryExtensionV1Ext) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyLedgerEntryExtensionV1Ext> for LedgerEntryExtensionV1Ext {
    type Error = Error;
    fn try_from(lazy: &LazyLedgerEntryExtensionV1Ext) -> Result<Self, Error> {
