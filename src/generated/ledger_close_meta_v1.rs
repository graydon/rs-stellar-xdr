...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`LedgerCloseMetaV1`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyLedgerCloseMetaV1(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyLedgerCloseMetaV1 {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyLedgerCloseMetaV1 {
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
        core::cmp::Ordering::Equal
            ...
            .then_with(|| self.unused().cmp(&other.unused()))
    }
}
#[cfg(feature = "alloc")]
impl LazyXdr for LazyLedgerCloseMetaV1 {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        {
            let field_len =
                <LazyVecM<LazyLedgerEntry> as LazyXdr>::xdr_validate(&buf[pos as usize..], depth)?;
            pos = pos.checked_add(field_len).ok_or(Error::LengthExceedsMax)?;
        }
        Ok(pos)
    }
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        pos += <LazyVecM<LazyLedgerEntry> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        pos
    }
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyLedgerCloseMetaV1 {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyLedgerCloseMetaV1 {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyLedgerCloseMetaV1 {
    type Error = Error;
...
impl LazyLedgerCloseMetaV1 {
    ...
    /// Access field `unused`.
    #[must_use]
    pub fn unused(&self) -> LazyVecM<LazyLedgerEntry> {
        let buf = self.0.as_slice();
        let mut pos: u32 = 0;
        pos += <LazyLedgerCloseMetaExt as LazyXdr>::xdr_len(&buf[pos as usize..]);
        pos += <LazyLedgerHeaderHistoryEntry as LazyXdr>::xdr_len(&buf[pos as usize..]);
        ...
        pos += 8;
        pos += <LazyVecM<LazyLedgerKey> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        <LazyVecM<LazyLedgerEntry> as LazyXdr>::from_xdr_at(&self.0, pos)
    }
}
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LedgerCloseMetaV1> for LazyLedgerCloseMetaV1 {
    type Error = Error;
    fn try_from(val: &LedgerCloseMetaV1) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyLedgerCloseMetaV1> for LedgerCloseMetaV1 {
    type Error = Error;
    fn try_from(lazy: &LazyLedgerCloseMetaV1) -> Result<Self, Error> {
