...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`ScSpecUdtStructV0`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyScSpecUdtStructV0(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyScSpecUdtStructV0 {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyScSpecUdtStructV0 {
...
impl LazyXdr for LazyScSpecUdtStructV0 {
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        pos += <LazyVecM<LazyScSpecUdtStructFieldV0> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        pos
    }
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyScSpecUdtStructV0 {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyScSpecUdtStructV0 {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyScSpecUdtStructV0 {
    type Error = Error;
...
impl LazyScSpecUdtStructV0 {
    ...
    /// Access field `fields`.
    #[must_use]
    pub fn fields(&self) -> LazyVecM<LazyScSpecUdtStructFieldV0> {
        let buf = self.0.as_slice();
        let mut pos: u32 = 0;
        pos += <LazyStringM<1024> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        pos += <LazyStringM<80> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        pos += <LazyStringM<60> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        <LazyVecM<LazyScSpecUdtStructFieldV0> as LazyXdr>::from_xdr_at(&self.0, pos)
    }
}
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&ScSpecUdtStructV0> for LazyScSpecUdtStructV0 {
    type Error = Error;
    fn try_from(val: &ScSpecUdtStructV0) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyScSpecUdtStructV0> for ScSpecUdtStructV0 {
    type Error = Error;
    fn try_from(lazy: &LazyScSpecUdtStructV0) -> Result<Self, Error> {
