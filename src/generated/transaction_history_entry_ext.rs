...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TransactionHistoryEntryExt`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTransactionHistoryEntryExt(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTransactionHistoryEntryExt {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTransactionHistoryEntryExt {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyTransactionHistoryEntryExt {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTransactionHistoryEntryExt {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTransactionHistoryEntryExt {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTransactionHistoryEntryExt {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyTransactionHistoryEntryExt {
...
impl TryFrom<&TransactionHistoryEntryExt> for LazyTransactionHistoryEntryExt {
    type Error = Error;
    fn try_from(val: &TransactionHistoryEntryExt) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTransactionHistoryEntryExt> for TransactionHistoryEntryExt {
    type Error = Error;
    fn try_from(lazy: &LazyTransactionHistoryEntryExt) -> Result<Self, Error> {
