...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`LedgerKeyTrustLine`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyLedgerKeyTrustLine(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyLedgerKeyTrustLine {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyLedgerKeyTrustLine {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyLedgerKeyTrustLine {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyLedgerKeyTrustLine {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyLedgerKeyTrustLine {
    type Error = Error;
...
impl TryFrom<&LedgerKeyTrustLine> for LazyLedgerKeyTrustLine {
    type Error = Error;
    fn try_from(val: &LedgerKeyTrustLine) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyLedgerKeyTrustLine> for LedgerKeyTrustLine {
    type Error = Error;
    fn try_from(lazy: &LazyLedgerKeyTrustLine) -> Result<Self, Error> {
