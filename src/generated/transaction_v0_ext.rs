...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TransactionV0Ext`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTransactionV0Ext(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTransactionV0Ext {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTransactionV0Ext {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyTransactionV0Ext {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTransactionV0Ext {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTransactionV0Ext {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTransactionV0Ext {
    type Error = Error;
...
impl TryFrom<&TransactionV0Ext> for LazyTransactionV0Ext {
    type Error = Error;
    fn try_from(val: &TransactionV0Ext) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTransactionV0Ext> for TransactionV0Ext {
    type Error = Error;
    fn try_from(lazy: &LazyTransactionV0Ext) -> Result<Self, Error> {
