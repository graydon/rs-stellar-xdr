...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`ExtensionPoint`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyExtensionPoint(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyExtensionPoint {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyExtensionPoint {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyExtensionPoint {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyExtensionPoint {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyExtensionPoint {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyExtensionPoint {
    type Error = Error;
...
impl TryFrom<&ExtensionPoint> for LazyExtensionPoint {
    type Error = Error;
    fn try_from(val: &ExtensionPoint) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyExtensionPoint> for ExtensionPoint {
    type Error = Error;
    fn try_from(lazy: &LazyExtensionPoint) -> Result<Self, Error> {
