...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`RestoreFootprintResult`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyRestoreFootprintResult(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyRestoreFootprintResult {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyRestoreFootprintResult {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyRestoreFootprintResult {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyRestoreFootprintResult {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyRestoreFootprintResult {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyRestoreFootprintResult {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyRestoreFootprintResult {
    ...
    #[must_use]
    pub fn discriminant(&self) -> RestoreFootprintResultCode {
        // Validated — unwrap is safe.
        RestoreFootprintResultCode::try_from(self.discriminant_i32()).unwrap()
    }
}
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&RestoreFootprintResult> for LazyRestoreFootprintResult {
    type Error = Error;
    fn try_from(val: &RestoreFootprintResult) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyRestoreFootprintResult> for RestoreFootprintResult {
    type Error = Error;
    fn try_from(lazy: &LazyRestoreFootprintResult) -> Result<Self, Error> {
