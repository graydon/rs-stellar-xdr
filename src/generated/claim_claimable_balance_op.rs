...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`ClaimClaimableBalanceOp`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyClaimClaimableBalanceOp(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyClaimClaimableBalanceOp {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyClaimClaimableBalanceOp {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyClaimClaimableBalanceOp {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyClaimClaimableBalanceOp {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyClaimClaimableBalanceOp {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyClaimClaimableBalanceOp {
...
impl TryFrom<&ClaimClaimableBalanceOp> for LazyClaimClaimableBalanceOp {
    type Error = Error;
    fn try_from(val: &ClaimClaimableBalanceOp) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyClaimClaimableBalanceOp> for ClaimClaimableBalanceOp {
    type Error = Error;
    fn try_from(lazy: &LazyClaimClaimableBalanceOp) -> Result<Self, Error> {
