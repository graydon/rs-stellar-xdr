...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TimeSlicedSurveyStartCollectingMessage`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTimeSlicedSurveyStartCollectingMessage(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTimeSlicedSurveyStartCollectingMessage {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTimeSlicedSurveyStartCollectingMessage {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTimeSlicedSurveyStartCollectingMessage {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTimeSlicedSurveyStartCollectingMessage {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTimeSlicedSurveyStartCollectingMessage {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyTimeSlicedSurveyStartCollectingMessage {
...
impl TryFrom<&TimeSlicedSurveyStartCollectingMessage>
    for LazyTimeSlicedSurveyStartCollectingMessage
{
    type Error = Error;
    fn try_from(val: &TimeSlicedSurveyStartCollectingMessage) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTimeSlicedSurveyStartCollectingMessage>
    for TimeSlicedSurveyStartCollectingMessage
{
    type Error = Error;
    fn try_from(lazy: &LazyTimeSlicedSurveyStartCollectingMessage) -> Result<Self, Error> {
