...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`LedgerHeaderExtensionV1Ext`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyLedgerHeaderExtensionV1Ext(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyLedgerHeaderExtensionV1Ext {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyLedgerHeaderExtensionV1Ext {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyLedgerHeaderExtensionV1Ext {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyLedgerHeaderExtensionV1Ext {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyLedgerHeaderExtensionV1Ext {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyLedgerHeaderExtensionV1Ext {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyLedgerHeaderExtensionV1Ext {
...
impl TryFrom<&LedgerHeaderExtensionV1Ext> for LazyLedgerHeaderExtensionV1Ext {
    type Error = Error;
    fn try_from(val: &LedgerHeaderExtensionV1Ext) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyLedgerHeaderExtensionV1Ext> for LedgerHeaderExtensionV1Ext {
    type Error = Error;
    fn try_from(lazy: &LazyLedgerHeaderExtensionV1Ext) -> Result<Self, Error> {
