...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TrustLineEntryExtensionV2Ext`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTrustLineEntryExtensionV2Ext(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTrustLineEntryExtensionV2Ext {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTrustLineEntryExtensionV2Ext {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyTrustLineEntryExtensionV2Ext {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTrustLineEntryExtensionV2Ext {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTrustLineEntryExtensionV2Ext {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTrustLineEntryExtensionV2Ext {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyTrustLineEntryExtensionV2Ext {
...
impl TryFrom<&TrustLineEntryExtensionV2Ext> for LazyTrustLineEntryExtensionV2Ext {
    type Error = Error;
    fn try_from(val: &TrustLineEntryExtensionV2Ext) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTrustLineEntryExtensionV2Ext> for TrustLineEntryExtensionV2Ext {
    type Error = Error;
    fn try_from(lazy: &LazyTrustLineEntryExtensionV2Ext) -> Result<Self, Error> {
