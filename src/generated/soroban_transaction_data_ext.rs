...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`SorobanTransactionDataExt`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazySorobanTransactionDataExt(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazySorobanTransactionDataExt {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazySorobanTransactionDataExt {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazySorobanTransactionDataExt {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            ...
            1 => {
                let field_len = <LazySorobanResourcesExtV0 as LazyXdr>::xdr_validate(
                    &buf[pos as usize..],
                    depth,
                )?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            ...
            1 => {
                pos += <LazySorobanResourcesExtV0 as LazyXdr>::xdr_len(&buf[pos as usize..]);
            }
            _ => {}
        }
        pos
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazySorobanTransactionDataExt {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazySorobanTransactionDataExt {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazySorobanTransactionDataExt {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazySorobanTransactionDataExt {
    ...
    #[must_use]
    pub fn as_v1(&self) -> Option<LazySorobanResourcesExtV0> {
        if self.discriminant_i32() == 1 {
            Some(<LazySorobanResourcesExtV0 as LazyXdr>::from_xdr_at(
                &self.0, 4,
            ))
        } else {
            None
...
impl TryFrom<&SorobanTransactionDataExt> for LazySorobanTransactionDataExt {
    type Error = Error;
    fn try_from(val: &SorobanTransactionDataExt) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazySorobanTransactionDataExt> for SorobanTransactionDataExt {
    type Error = Error;
    fn try_from(lazy: &LazySorobanTransactionDataExt) -> Result<Self, Error> {
