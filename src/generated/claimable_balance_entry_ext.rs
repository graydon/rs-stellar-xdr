...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`ClaimableBalanceEntryExt`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyClaimableBalanceEntryExt(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyClaimableBalanceEntryExt {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyClaimableBalanceEntryExt {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyClaimableBalanceEntryExt {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            ...
            1 => {
                let field_len = <LazyClaimableBalanceEntryExtensionV1 as LazyXdr>::xdr_validate(
                    &buf[pos as usize..],
                    depth,
                )?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            ...
            1 => {
                pos += <LazyClaimableBalanceEntryExtensionV1 as LazyXdr>::xdr_len(
                    &buf[pos as usize..],
                );
            }
            _ => {}
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyClaimableBalanceEntryExt {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyClaimableBalanceEntryExt {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyClaimableBalanceEntryExt {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyClaimableBalanceEntryExt {
    ...
    #[must_use]
    pub fn as_v1(&self) -> Option<LazyClaimableBalanceEntryExtensionV1> {
        if self.discriminant_i32() == 1 {
            Some(<LazyClaimableBalanceEntryExtensionV1 as LazyXdr>::from_xdr_at(&self.0, 4))
        } else {
            None
        }
    }
...
impl TryFrom<&ClaimableBalanceEntryExt> for LazyClaimableBalanceEntryExt {
    type Error = Error;
    fn try_from(val: &ClaimableBalanceEntryExt) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyClaimableBalanceEntryExt> for ClaimableBalanceEntryExt {
    type Error = Error;
    fn try_from(lazy: &LazyClaimableBalanceEntryExt) -> Result<Self, Error> {
