...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`ExtendFootprintTtlOp`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyExtendFootprintTtlOp(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyExtendFootprintTtlOp {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyExtendFootprintTtlOp {
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
        core::cmp::Ordering::Equal
            .then_with(|| self.ext().cmp(&other.ext()))
            .then_with(|| self.extend_to().cmp(&other.extend_to()))
    }
}
#[cfg(feature = "alloc")]
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyExtendFootprintTtlOp {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyExtendFootprintTtlOp {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyExtendFootprintTtlOp {
    type Error = Error;
...
impl TryFrom<&ExtendFootprintTtlOp> for LazyExtendFootprintTtlOp {
    type Error = Error;
    fn try_from(val: &ExtendFootprintTtlOp) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyExtendFootprintTtlOp> for ExtendFootprintTtlOp {
    type Error = Error;
    fn try_from(lazy: &LazyExtendFootprintTtlOp) -> Result<Self, Error> {
