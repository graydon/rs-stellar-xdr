...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`ScSpecUdtErrorEnumV0`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyScSpecUdtErrorEnumV0(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyScSpecUdtErrorEnumV0 {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyScSpecUdtErrorEnumV0 {
...
impl LazyXdr for LazyScSpecUdtErrorEnumV0 {
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        pos += <LazyVecM<LazyScSpecUdtErrorEnumCaseV0> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        pos
    }
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyScSpecUdtErrorEnumV0 {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyScSpecUdtErrorEnumV0 {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyScSpecUdtErrorEnumV0 {
    type Error = Error;
...
impl LazyScSpecUdtErrorEnumV0 {
    ...
    /// Access field `cases`.
    #[must_use]
    pub fn cases(&self) -> LazyVecM<LazyScSpecUdtErrorEnumCaseV0> {
        let buf = self.0.as_slice();
        let mut pos: u32 = 0;
        pos += <LazyStringM<1024> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        pos += <LazyStringM<80> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        pos += <LazyStringM<60> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        <LazyVecM<LazyScSpecUdtErrorEnumCaseV0> as LazyXdr>::from_xdr_at(&self.0, pos)
    }
}
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&ScSpecUdtErrorEnumV0> for LazyScSpecUdtErrorEnumV0 {
    type Error = Error;
    fn try_from(val: &ScSpecUdtErrorEnumV0) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyScSpecUdtErrorEnumV0> for ScSpecUdtErrorEnumV0 {
    type Error = Error;
    fn try_from(lazy: &LazyScSpecUdtErrorEnumV0) -> Result<Self, Error> {
