...
#[cfg(feature = "alloc")]
// Enum EnvelopeType: scalar lazy type — impl LazyXdr directly on the enum.
impl LazyXdr for EnvelopeType {
    ...
    fn from_xdr_consume(_parent: &LazyHandle, buf: &mut &[u8]) -> Self {
        ...
        *buf = &buf[4..];
        ...
        EnvelopeType::try_from(v).unwrap()
    }
}
