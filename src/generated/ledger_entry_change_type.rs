...
#[cfg(feature = "alloc")]
// Enum LedgerEntryChangeType: scalar lazy type — impl LazyXdr directly on the enum.
impl LazyXdr for LedgerEntryChangeType {
    ...
    fn xdr_validate(buf: &[u8], _depth: u32) -> Result<u32, Error> {
        ...
        let _ = LedgerEntryChangeType::try_from(v)?;
        Ok(4)
    }
    ...
    fn from_xdr_consume(_parent: &LazyHandle, buf: &mut &[u8]) -> Self {
        ...
        *buf = &buf[4..];
        ...
        LedgerEntryChangeType::try_from(v).unwrap()
    }
}
