...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TrustLineEntryV1Ext`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTrustLineEntryV1Ext(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTrustLineEntryV1Ext {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTrustLineEntryV1Ext {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyTrustLineEntryV1Ext {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            ...
            2 => {
                let field_len = <LazyTrustLineEntryExtensionV2 as LazyXdr>::xdr_validate(
                    &buf[pos as usize..],
                    depth,
                )?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            ...
            2 => {
                pos += <LazyTrustLineEntryExtensionV2 as LazyXdr>::xdr_len(&buf[pos as usize..]);
            }
            _ => {}
        }
        pos
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTrustLineEntryV1Ext {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTrustLineEntryV1Ext {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTrustLineEntryV1Ext {
    type Error = Error;
...
impl LazyTrustLineEntryV1Ext {
    ...
    #[must_use]
    pub fn as_v2(&self) -> Option<LazyTrustLineEntryExtensionV2> {
        if self.discriminant_i32() == 2 {
            Some(<LazyTrustLineEntryExtensionV2 as LazyXdr>::from_xdr_at(
                &self.0, 4,
            ))
        } else {
            None
...
impl TryFrom<&TrustLineEntryV1Ext> for LazyTrustLineEntryV1Ext {
    type Error = Error;
    fn try_from(val: &TrustLineEntryV1Ext) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTrustLineEntryV1Ext> for TrustLineEntryV1Ext {
    type Error = Error;
    fn try_from(lazy: &LazyTrustLineEntryV1Ext) -> Result<Self, Error> {
