...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`Asset`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyAsset(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyAsset {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyAsset {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyAsset {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyAsset {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyAsset {
    type Error = Error;
...
impl TryFrom<&Asset> for LazyAsset {
    type Error = Error;
    fn try_from(val: &Asset) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyAsset> for Asset {
    type Error = Error;
    fn try_from(lazy: &LazyAsset) -> Result<Self, Error> {
