...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`ScEnvMetaEntry`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyScEnvMetaEntry(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyScEnvMetaEntry {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyScEnvMetaEntry {
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
        ...
        match self.discriminant_i32() {
            0 => self
                .as_sc_env_meta_kind_interface_version()
                .cmp(&other.as_sc_env_meta_kind_interface_version()),
            _ => core::cmp::Ordering::Equal,
        }
    }
}
#[cfg(feature = "alloc")]
impl LazyXdr for LazyScEnvMetaEntry {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            0 => {
                let field_len = <LazyScEnvMetaEntryInterfaceVersion as LazyXdr>::xdr_validate(
                    &buf[pos as usize..],
                    depth,
                )?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            0 => {
                pos +=
                    <LazyScEnvMetaEntryInterfaceVersion as LazyXdr>::xdr_len(&buf[pos as usize..]);
            }
            _ => {}
        }
        pos
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyScEnvMetaEntry {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyScEnvMetaEntry {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyScEnvMetaEntry {
    type Error = Error;
...
impl LazyScEnvMetaEntry {
    ...
    #[must_use]
    pub fn discriminant(&self) -> ScEnvMetaKind {
        // Validated — unwrap is safe.
        ScEnvMetaKind::try_from(self.discriminant_i32()).unwrap()
    }
    ...
    pub fn as_sc_env_meta_kind_interface_version(
        ...
        if self.discriminant_i32() == 0 {
            Some(<LazyScEnvMetaEntryInterfaceVersion as LazyXdr>::from_xdr_at(&self.0, 4))
        } else {
            None
        }
    }
...
impl TryFrom<&ScEnvMetaEntry> for LazyScEnvMetaEntry {
    type Error = Error;
    fn try_from(val: &ScEnvMetaEntry) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyScEnvMetaEntry> for ScEnvMetaEntry {
    type Error = Error;
    fn try_from(lazy: &LazyScEnvMetaEntry) -> Result<Self, Error> {
