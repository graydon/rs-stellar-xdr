...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`ClaimClaimableBalanceResult`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyClaimClaimableBalanceResult(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyClaimClaimableBalanceResult {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyClaimClaimableBalanceResult {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyClaimClaimableBalanceResult {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyClaimClaimableBalanceResult {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyClaimClaimableBalanceResult {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyClaimClaimableBalanceResult {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyClaimClaimableBalanceResult {
    ...
    pub fn discriminant(&self) -> ClaimClaimableBalanceResultCode {
        ...
        ClaimClaimableBalanceResultCode::try_from(self.discriminant_i32()).unwrap()
    }
}
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&ClaimClaimableBalanceResult> for LazyClaimClaimableBalanceResult {
    type Error = Error;
    fn try_from(val: &ClaimClaimableBalanceResult) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyClaimClaimableBalanceResult> for ClaimClaimableBalanceResult {
    type Error = Error;
    fn try_from(lazy: &LazyClaimClaimableBalanceResult) -> Result<Self, Error> {
