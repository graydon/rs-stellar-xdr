...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`LedgerKeyContractData`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyLedgerKeyContractData(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyLedgerKeyContractData {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyLedgerKeyContractData {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyLedgerKeyContractData {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyLedgerKeyContractData {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyLedgerKeyContractData {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyLedgerKeyContractData {
...
impl TryFrom<&LedgerKeyContractData> for LazyLedgerKeyContractData {
    type Error = Error;
    fn try_from(val: &LedgerKeyContractData) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyLedgerKeyContractData> for LedgerKeyContractData {
    type Error = Error;
    fn try_from(lazy: &LazyLedgerKeyContractData) -> Result<Self, Error> {
