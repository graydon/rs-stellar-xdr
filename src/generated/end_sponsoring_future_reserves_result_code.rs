...
impl LazyXdr for EndSponsoringFutureReservesResultCode {
    ...
    fn xdr_validate(buf: &[u8], _depth: u32) -> Result<u32, Error> {
        ...
        let _ = EndSponsoringFutureReservesResultCode::try_from(v)?;
        Ok(4)
    }
    ...
    fn from_xdr_at(parent: &LazyHandle, offset: u32) -> Self {
        ...
        EndSponsoringFutureReservesResultCode::try_from(v).unwrap()
    }
}
