...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TransactionResultResult`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTransactionResultResult(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTransactionResultResult {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTransactionResultResult {
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
        ...
        match self.discriminant_i32() {
            1 => self
                .as_tx_fee_bump_inner_success()
                .cmp(&other.as_tx_fee_bump_inner_success()),
            -13 => self
                .as_tx_fee_bump_inner_failed()
                .cmp(&other.as_tx_fee_bump_inner_failed()),
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyTransactionResultResult {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            1 => {
                let field_len = <LazyInnerTransactionResultPair as LazyXdr>::xdr_validate(
                    &buf[pos as usize..],
                    depth,
                )?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            1 => {
                pos += <LazyInnerTransactionResultPair as LazyXdr>::xdr_len(&buf[pos as usize..]);
            }
            -13 => {
                pos += <LazyInnerTransactionResultPair as LazyXdr>::xdr_len(&buf[pos as usize..]);
            }
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTransactionResultResult {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTransactionResultResult {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTransactionResultResult {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyTransactionResultResult {
...
impl TryFrom<&TransactionResultResult> for LazyTransactionResultResult {
    type Error = Error;
    fn try_from(val: &TransactionResultResult) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTransactionResultResult> for TransactionResultResult {
    type Error = Error;
    fn try_from(lazy: &LazyTransactionResultResult) -> Result<Self, Error> {
