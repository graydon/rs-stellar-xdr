...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`LedgerEntryExt`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyLedgerEntryExt(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyLedgerEntryExt {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyLedgerEntryExt {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyLedgerEntryExt {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            ...
            1 => {
                let field_len = <LazyLedgerEntryExtensionV1 as LazyXdr>::xdr_validate(
                    &buf[pos as usize..],
                    depth,
                )?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            ...
            1 => {
                pos += <LazyLedgerEntryExtensionV1 as LazyXdr>::xdr_len(&buf[pos as usize..]);
            }
            _ => {}
        }
        pos
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyLedgerEntryExt {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyLedgerEntryExt {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyLedgerEntryExt {
    type Error = Error;
...
impl LazyLedgerEntryExt {
    ...
    #[must_use]
    pub fn as_v1(&self) -> Option<LazyLedgerEntryExtensionV1> {
        if self.discriminant_i32() == 1 {
            Some(<LazyLedgerEntryExtensionV1 as LazyXdr>::from_xdr_at(
                &self.0, 4,
            ))
        } else {
            None
...
impl TryFrom<&LedgerEntryExt> for LazyLedgerEntryExt {
    type Error = Error;
    fn try_from(val: &LedgerEntryExt) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyLedgerEntryExt> for LedgerEntryExt {
    type Error = Error;
    fn try_from(lazy: &LazyLedgerEntryExt) -> Result<Self, Error> {
