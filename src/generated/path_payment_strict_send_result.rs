...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`PathPaymentStrictSendResult`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyPathPaymentStrictSendResult(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyPathPaymentStrictSendResult {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyPathPaymentStrictSendResult {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyPathPaymentStrictSendResult {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            0 => {
                let field_len = <LazyPathPaymentStrictSendResultSuccess as LazyXdr>::xdr_validate(
                    &buf[pos as usize..],
                    depth,
                )?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            0 => {
                pos += <LazyPathPaymentStrictSendResultSuccess as LazyXdr>::xdr_len(
                    &buf[pos as usize..],
                );
            }
            -1 => {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyPathPaymentStrictSendResult {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyPathPaymentStrictSendResult {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyPathPaymentStrictSendResult {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyPathPaymentStrictSendResult {
    ...
    pub fn discriminant(&self) -> PathPaymentStrictSendResultCode {
        ...
        PathPaymentStrictSendResultCode::try_from(self.discriminant_i32()).unwrap()
    }
    /// Access arm `Success`. Returns `Some` if the discriminant matches.
    #[must_use]
    pub fn as_success(&self) -> Option<LazyPathPaymentStrictSendResultSuccess> {
        if self.discriminant_i32() == 0 {
            Some(<LazyPathPaymentStrictSendResultSuccess as LazyXdr>::from_xdr_at(&self.0, 4))
        } else {
            None
        }
    }
...
impl TryFrom<&PathPaymentStrictSendResult> for LazyPathPaymentStrictSendResult {
    type Error = Error;
    fn try_from(val: &PathPaymentStrictSendResult) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyPathPaymentStrictSendResult> for PathPaymentStrictSendResult {
    type Error = Error;
    fn try_from(lazy: &LazyPathPaymentStrictSendResult) -> Result<Self, Error> {
