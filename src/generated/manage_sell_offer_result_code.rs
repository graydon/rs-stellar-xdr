...
#[cfg(feature = "alloc")]
// Enum ManageSellOfferResultCode: scalar lazy type — impl LazyXdr directly on the enum.
impl LazyXdr for ManageSellOfferResultCode {
    ...
    fn xdr_validate(buf: &[u8], _depth: u32) -> Result<u32, Error> {
        ...
        let _ = ManageSellOfferResultCode::try_from(v)?;
        Ok(4)
    }
    ...
    fn from_xdr_at(parent: &LazyHandle, offset: u32) -> Self {
        ...
        ManageSellOfferResultCode::try_from(v).unwrap()
    }
}
