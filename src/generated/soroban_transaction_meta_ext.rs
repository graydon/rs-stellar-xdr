...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`SorobanTransactionMetaExt`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazySorobanTransactionMetaExt(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazySorobanTransactionMetaExt {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazySorobanTransactionMetaExt {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazySorobanTransactionMetaExt {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            ...
            1 => {
                let field_len = <LazySorobanTransactionMetaExtV1 as LazyXdr>::xdr_validate(
                    &buf[pos as usize..],
                    depth,
                )?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            ...
            1 => {
                pos += <LazySorobanTransactionMetaExtV1 as LazyXdr>::xdr_len(&buf[pos as usize..]);
            }
            _ => {}
        }
        pos
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazySorobanTransactionMetaExt {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazySorobanTransactionMetaExt {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazySorobanTransactionMetaExt {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazySorobanTransactionMetaExt {
    ...
    #[must_use]
    pub fn as_v1(&self) -> Option<LazySorobanTransactionMetaExtV1> {
        if self.discriminant_i32() == 1 {
            Some(<LazySorobanTransactionMetaExtV1 as LazyXdr>::from_xdr_at(
                &self.0, 4,
            ))
        } else {
            None
...
impl TryFrom<&SorobanTransactionMetaExt> for LazySorobanTransactionMetaExt {
    type Error = Error;
    fn try_from(val: &SorobanTransactionMetaExt) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazySorobanTransactionMetaExt> for SorobanTransactionMetaExt {
    type Error = Error;
    fn try_from(lazy: &LazySorobanTransactionMetaExt) -> Result<Self, Error> {
