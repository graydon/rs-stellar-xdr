...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TransactionMetaV1`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTransactionMetaV1(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTransactionMetaV1 {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTransactionMetaV1 {
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
        core::cmp::Ordering::Equal
            .then_with(|| self.tx_changes().cmp(&other.tx_changes()))
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTransactionMetaV1 {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTransactionMetaV1 {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTransactionMetaV1 {
    type Error = Error;
...
impl TryFrom<&TransactionMetaV1> for LazyTransactionMetaV1 {
    type Error = Error;
    fn try_from(val: &TransactionMetaV1) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTransactionMetaV1> for TransactionMetaV1 {
    type Error = Error;
    fn try_from(lazy: &LazyTransactionMetaV1) -> Result<Self, Error> {
