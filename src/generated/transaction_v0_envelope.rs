...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TransactionV0Envelope`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTransactionV0Envelope(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTransactionV0Envelope {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTransactionV0Envelope {
...
impl LazyXdr for LazyTransactionV0Envelope {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        {
            let field_len =
                <LazyTransactionV0 as LazyXdr>::xdr_validate(&buf[pos as usize..], depth)?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        let mut pos: u32 = 0;
        pos += <LazyTransactionV0 as LazyXdr>::xdr_len(&buf[pos as usize..]);
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTransactionV0Envelope {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTransactionV0Envelope {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTransactionV0Envelope {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyTransactionV0Envelope {
    /// Access field `tx`.
    #[must_use]
...
impl TryFrom<&TransactionV0Envelope> for LazyTransactionV0Envelope {
    type Error = Error;
    fn try_from(val: &TransactionV0Envelope) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTransactionV0Envelope> for TransactionV0Envelope {
    type Error = Error;
    fn try_from(lazy: &LazyTransactionV0Envelope) -> Result<Self, Error> {
