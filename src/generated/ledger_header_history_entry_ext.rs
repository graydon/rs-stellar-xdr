...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`LedgerHeaderHistoryEntryExt`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyLedgerHeaderHistoryEntryExt(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyLedgerHeaderHistoryEntryExt {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyLedgerHeaderHistoryEntryExt {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyLedgerHeaderHistoryEntryExt {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyLedgerHeaderHistoryEntryExt {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyLedgerHeaderHistoryEntryExt {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyLedgerHeaderHistoryEntryExt {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyLedgerHeaderHistoryEntryExt {
...
impl TryFrom<&LedgerHeaderHistoryEntryExt> for LazyLedgerHeaderHistoryEntryExt {
    type Error = Error;
    fn try_from(val: &LedgerHeaderHistoryEntryExt) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyLedgerHeaderHistoryEntryExt> for LedgerHeaderHistoryEntryExt {
    type Error = Error;
    fn try_from(lazy: &LazyLedgerHeaderHistoryEntryExt) -> Result<Self, Error> {
