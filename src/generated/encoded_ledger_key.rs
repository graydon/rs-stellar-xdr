...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`EncodedLedgerKey`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyEncodedLedgerKey(LazyBytesM);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyEncodedLedgerKey {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyEncodedLedgerKey {
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
        self.0.cmp(&other.0)
    }
}
#[cfg(feature = "alloc")]
impl LazyXdr for LazyEncodedLedgerKey {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyEncodedLedgerKey {
    fn from(h: LazyHandle) -> Self {
        Self(<LazyBytesM>::from(h))
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyEncodedLedgerKey {
    fn as_ref(&self) -> &LazyHandle {
        self.0.as_ref()
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyEncodedLedgerKey {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl core::ops::Deref for LazyEncodedLedgerKey {
...
impl TryFrom<&EncodedLedgerKey> for LazyEncodedLedgerKey {
    type Error = Error;
    fn try_from(val: &EncodedLedgerKey) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyEncodedLedgerKey> for EncodedLedgerKey {
    type Error = Error;
    fn try_from(lazy: &LazyEncodedLedgerKey) -> Result<Self, Error> {
