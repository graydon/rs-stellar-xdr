...
#[cfg(feature = "alloc")]
// Enum SurveyMessageResponseType: scalar lazy type — impl LazyXdr directly on the enum.
impl LazyXdr for SurveyMessageResponseType {
    ...
    fn xdr_validate(buf: &[u8], _depth: u32) -> Result<u32, Error> {
        ...
        let _ = SurveyMessageResponseType::try_from(v)?;
        Ok(4)
    }
    ...
    fn from_xdr_at(parent: &LazyHandle, offset: u32) -> Self {
        ...
        SurveyMessageResponseType::try_from(v).unwrap()
    }
}
