...
#[cfg(feature = "alloc")]
// Enum PublicKeyType: scalar lazy type — impl LazyXdr directly on the enum.
impl LazyXdr for PublicKeyType {
    ...
    fn xdr_validate(buf: &[u8], _depth: u32) -> Result<u32, Error> {
        ...
        let _ = PublicKeyType::try_from(v)?;
        Ok(4)
    }
    ...
    fn from_xdr_at(parent: &LazyHandle, offset: u32) -> Self {
        ...
        PublicKeyType::try_from(v).unwrap()
    }
}
