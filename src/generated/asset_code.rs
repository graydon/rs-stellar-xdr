...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`AssetCode`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyAssetCode(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyAssetCode {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyAssetCode {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyAssetCode {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            1 => {
                let field_len =
                    <LazyAssetCode4 as LazyXdr>::xdr_validate(&buf[pos as usize..], depth)?;
                pos = pos.checked_add(field_len).ok_or(Error::LengthExceedsMax)?;
            }
            2 => {
                let field_len =
                    <LazyAssetCode12 as LazyXdr>::xdr_validate(&buf[pos as usize..], depth)?;
                pos = pos.checked_add(field_len).ok_or(Error::LengthExceedsMax)?;
            }
            _ => return Err(Error::Invalid),
        }
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            1 => {
                pos += <LazyAssetCode4 as LazyXdr>::xdr_len(&buf[pos as usize..]);
            }
            2 => {
                pos += <LazyAssetCode12 as LazyXdr>::xdr_len(&buf[pos as usize..]);
            }
            _ => {}
        }
        pos
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyAssetCode {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyAssetCode {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyAssetCode {
    type Error = Error;
...
impl TryFrom<&AssetCode> for LazyAssetCode {
    type Error = Error;
    fn try_from(val: &AssetCode) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyAssetCode> for AssetCode {
    type Error = Error;
    fn try_from(lazy: &LazyAssetCode) -> Result<Self, Error> {
