...
#[cfg(feature = "alloc")]
// Enum AccountFlags: scalar lazy type — impl LazyXdr directly on the enum.
impl LazyXdr for AccountFlags {
    ...
    fn from_xdr_consume(_parent: &LazyHandle, buf: &mut &[u8]) -> Self {
        ...
        *buf = &buf[4..];
        ...
        AccountFlags::try_from(v).unwrap()
    }
}
