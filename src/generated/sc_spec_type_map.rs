...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`ScSpecTypeMap`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyScSpecTypeMap(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyScSpecTypeMap {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyScSpecTypeMap {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyScSpecTypeMap {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyScSpecTypeMap {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyScSpecTypeMap {
    type Error = Error;
...
impl TryFrom<&ScSpecTypeMap> for LazyScSpecTypeMap {
    type Error = Error;
    fn try_from(val: &ScSpecTypeMap) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyScSpecTypeMap> for ScSpecTypeMap {
    type Error = Error;
    fn try_from(lazy: &LazyScSpecTypeMap) -> Result<Self, Error> {
