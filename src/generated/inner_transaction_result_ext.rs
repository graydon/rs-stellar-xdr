...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`InnerTransactionResultExt`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyInnerTransactionResultExt(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyInnerTransactionResultExt {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyInnerTransactionResultExt {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyInnerTransactionResultExt {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyInnerTransactionResultExt {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyInnerTransactionResultExt {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyInnerTransactionResultExt {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyInnerTransactionResultExt {
...
impl TryFrom<&InnerTransactionResultExt> for LazyInnerTransactionResultExt {
    type Error = Error;
    fn try_from(val: &InnerTransactionResultExt) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyInnerTransactionResultExt> for InnerTransactionResultExt {
    type Error = Error;
    fn try_from(lazy: &LazyInnerTransactionResultExt) -> Result<Self, Error> {
