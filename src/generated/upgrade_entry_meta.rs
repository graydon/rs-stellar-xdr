...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`UpgradeEntryMeta`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyUpgradeEntryMeta(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyUpgradeEntryMeta {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyUpgradeEntryMeta {
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
        core::cmp::Ordering::Equal
            .then_with(|| self.upgrade().cmp(&other.upgrade()))
...
impl LazyXdr for LazyUpgradeEntryMeta {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        {
            let field_len =
                <LazyLedgerUpgrade as LazyXdr>::xdr_validate(&buf[pos as usize..], depth)?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        let mut pos: u32 = 0;
        pos += <LazyLedgerUpgrade as LazyXdr>::xdr_len(&buf[pos as usize..]);
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyUpgradeEntryMeta {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyUpgradeEntryMeta {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyUpgradeEntryMeta {
    type Error = Error;
...
impl TryFrom<&UpgradeEntryMeta> for LazyUpgradeEntryMeta {
    type Error = Error;
    fn try_from(val: &UpgradeEntryMeta) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyUpgradeEntryMeta> for UpgradeEntryMeta {
    type Error = Error;
    fn try_from(lazy: &LazyUpgradeEntryMeta) -> Result<Self, Error> {
