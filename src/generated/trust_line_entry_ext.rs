...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TrustLineEntryExt`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTrustLineEntryExt(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTrustLineEntryExt {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTrustLineEntryExt {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyTrustLineEntryExt {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            ...
            1 => {
                let field_len =
                    <LazyTrustLineEntryV1 as LazyXdr>::xdr_validate(&buf[pos as usize..], depth)?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            ...
            1 => {
                pos += <LazyTrustLineEntryV1 as LazyXdr>::xdr_len(&buf[pos as usize..]);
            }
            _ => {}
        }
        pos
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTrustLineEntryExt {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTrustLineEntryExt {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTrustLineEntryExt {
    type Error = Error;
...
impl LazyTrustLineEntryExt {
    ...
    #[must_use]
    pub fn as_v1(&self) -> Option<LazyTrustLineEntryV1> {
        if self.discriminant_i32() == 1 {
            Some(<LazyTrustLineEntryV1 as LazyXdr>::from_xdr_at(&self.0, 4))
        } else {
            None
        }
    }
...
impl TryFrom<&TrustLineEntryExt> for LazyTrustLineEntryExt {
    type Error = Error;
    fn try_from(val: &TrustLineEntryExt) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTrustLineEntryExt> for TrustLineEntryExt {
    type Error = Error;
    fn try_from(lazy: &LazyTrustLineEntryExt) -> Result<Self, Error> {
