...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TransactionResultExt`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTransactionResultExt(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTransactionResultExt {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTransactionResultExt {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyTransactionResultExt {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTransactionResultExt {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTransactionResultExt {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTransactionResultExt {
    type Error = Error;
...
impl TryFrom<&TransactionResultExt> for LazyTransactionResultExt {
    type Error = Error;
    fn try_from(val: &TransactionResultExt) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTransactionResultExt> for TransactionResultExt {
    type Error = Error;
    fn try_from(lazy: &LazyTransactionResultExt) -> Result<Self, Error> {
