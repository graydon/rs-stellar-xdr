...
#[cfg(feature = "alloc")]
// Enum SetOptionsResultCode: scalar lazy type — impl LazyXdr directly on the enum.
impl LazyXdr for SetOptionsResultCode {
    ...
    fn xdr_validate(buf: &[u8], _depth: u32) -> Result<u32, Error> {
        ...
        let _ = SetOptionsResultCode::try_from(v)?;
        Ok(4)
    }
    ...
    fn from_xdr_at(parent: &LazyHandle, offset: u32) -> Self {
        ...
        SetOptionsResultCode::try_from(v).unwrap()
    }
}
