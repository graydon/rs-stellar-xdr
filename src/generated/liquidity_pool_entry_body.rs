...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`LiquidityPoolEntryBody`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyLiquidityPoolEntryBody(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyLiquidityPoolEntryBody {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyLiquidityPoolEntryBody {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyLiquidityPoolEntryBody {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            0 => {
                let field_len = <LazyLiquidityPoolEntryConstantProduct as LazyXdr>::xdr_validate(
                    &buf[pos as usize..],
                    depth,
                )?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            0 => {
                pos += <LazyLiquidityPoolEntryConstantProduct as LazyXdr>::xdr_len(
                    &buf[pos as usize..],
                );
            }
            _ => {}
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyLiquidityPoolEntryBody {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyLiquidityPoolEntryBody {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyLiquidityPoolEntryBody {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyLiquidityPoolEntryBody {
    ...
    pub fn as_liquidity_pool_constant_product(
        ...
        if self.discriminant_i32() == 0 {
            Some(<LazyLiquidityPoolEntryConstantProduct as LazyXdr>::from_xdr_at(&self.0, 4))
        } else {
            None
        }
    }
...
impl TryFrom<&LiquidityPoolEntryBody> for LazyLiquidityPoolEntryBody {
    type Error = Error;
    fn try_from(val: &LiquidityPoolEntryBody) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyLiquidityPoolEntryBody> for LiquidityPoolEntryBody {
    type Error = Error;
    fn try_from(lazy: &LazyLiquidityPoolEntryBody) -> Result<Self, Error> {
