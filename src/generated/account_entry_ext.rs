...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`AccountEntryExt`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyAccountEntryExt(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyAccountEntryExt {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyAccountEntryExt {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyAccountEntryExt {
    fn xdr_validate(buf: &[u8], depth: u32) -> Result<u32, Error> {
        ...
        match disc {
            ...
            1 => {
                let field_len = <LazyAccountEntryExtensionV1 as LazyXdr>::xdr_validate(
                    &buf[pos as usize..],
                    depth,
                )?;
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        match disc {
            ...
            1 => {
                pos += <LazyAccountEntryExtensionV1 as LazyXdr>::xdr_len(&buf[pos as usize..]);
            }
            _ => {}
        }
        pos
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyAccountEntryExt {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyAccountEntryExt {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyAccountEntryExt {
    type Error = Error;
...
impl LazyAccountEntryExt {
    ...
    #[must_use]
    pub fn as_v1(&self) -> Option<LazyAccountEntryExtensionV1> {
        if self.discriminant_i32() == 1 {
            Some(<LazyAccountEntryExtensionV1 as LazyXdr>::from_xdr_at(
                &self.0, 4,
            ))
        } else {
            None
...
impl TryFrom<&AccountEntryExt> for LazyAccountEntryExt {
    type Error = Error;
    fn try_from(val: &AccountEntryExt) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyAccountEntryExt> for AccountEntryExt {
    type Error = Error;
    fn try_from(lazy: &LazyAccountEntryExt) -> Result<Self, Error> {
