...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`DataEntryExt`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyDataEntryExt(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyDataEntryExt {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyDataEntryExt {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyDataEntryExt {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyDataEntryExt {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyDataEntryExt {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyDataEntryExt {
    type Error = Error;
...
impl TryFrom<&DataEntryExt> for LazyDataEntryExt {
    type Error = Error;
    fn try_from(val: &DataEntryExt) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyDataEntryExt> for DataEntryExt {
    type Error = Error;
    fn try_from(lazy: &LazyDataEntryExt) -> Result<Self, Error> {
