...
#[cfg(feature = "alloc")]
// Enum ClaimantType: scalar lazy type — impl LazyXdr directly on the enum.
impl LazyXdr for ClaimantType {
    ...
    fn from_xdr_consume(_parent: &LazyHandle, buf: &mut &[u8]) -> Self {
        ...
        *buf = &buf[4..];
        ...
        ClaimantType::try_from(v).unwrap()
    }
}
