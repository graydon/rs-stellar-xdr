...
#[cfg(feature = "alloc")]
// Enum HotArchiveBucketEntryType: scalar lazy type — impl LazyXdr directly on the enum.
impl LazyXdr for HotArchiveBucketEntryType {
    ...
    fn xdr_validate(buf: &[u8], _depth: u32) -> Result<u32, Error> {
        ...
        let _ = HotArchiveBucketEntryType::try_from(v)?;
        Ok(4)
    }
    ...
    fn from_xdr_consume(_parent: &LazyHandle, buf: &mut &[u8]) -> Self {
        ...
        *buf = &buf[4..];
        ...
        HotArchiveBucketEntryType::try_from(v).unwrap()
    }
}
