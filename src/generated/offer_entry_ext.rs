...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`OfferEntryExt`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyOfferEntryExt(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyOfferEntryExt {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyOfferEntryExt {
...
#[cfg(feature = "alloc")]
impl LazyXdr for LazyOfferEntryExt {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyOfferEntryExt {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyOfferEntryExt {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyOfferEntryExt {
    type Error = Error;
...
impl TryFrom<&OfferEntryExt> for LazyOfferEntryExt {
    type Error = Error;
    fn try_from(val: &OfferEntryExt) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyOfferEntryExt> for OfferEntryExt {
    type Error = Error;
    fn try_from(lazy: &LazyOfferEntryExt) -> Result<Self, Error> {
