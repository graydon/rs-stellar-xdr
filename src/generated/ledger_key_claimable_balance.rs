...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`LedgerKeyClaimableBalance`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyLedgerKeyClaimableBalance(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyLedgerKeyClaimableBalance {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyLedgerKeyClaimableBalance {
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyLedgerKeyClaimableBalance {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyLedgerKeyClaimableBalance {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyLedgerKeyClaimableBalance {
    type Error = Error;
...
#[cfg(feature = "alloc")]
impl LazyLedgerKeyClaimableBalance {
...
impl TryFrom<&LedgerKeyClaimableBalance> for LazyLedgerKeyClaimableBalance {
    type Error = Error;
    fn try_from(val: &LedgerKeyClaimableBalance) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyLedgerKeyClaimableBalance> for LedgerKeyClaimableBalance {
    type Error = Error;
    fn try_from(lazy: &LazyLedgerKeyClaimableBalance) -> Result<Self, Error> {
