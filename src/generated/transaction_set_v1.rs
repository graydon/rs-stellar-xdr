...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`TransactionSetV1`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyTransactionSetV1(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyTransactionSetV1 {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyTransactionSetV1 {
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
        core::cmp::Ordering::Equal
            ...
            .then_with(|| self.phases().cmp(&other.phases()))
    }
}
#[cfg(feature = "alloc")]
impl LazyXdr for LazyTransactionSetV1 {
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        let mut pos: u32 = 0;
        pos += 32;
        pos += <LazyVecM<LazyTransactionPhase> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        pos
    }
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyTransactionSetV1 {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyTransactionSetV1 {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyTransactionSetV1 {
    type Error = Error;
...
impl TryFrom<&TransactionSetV1> for LazyTransactionSetV1 {
    type Error = Error;
    fn try_from(val: &TransactionSetV1) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyTransactionSetV1> for TransactionSetV1 {
    type Error = Error;
    fn try_from(lazy: &LazyTransactionSetV1) -> Result<Self, Error> {
