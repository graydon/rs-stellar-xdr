...
#[cfg(feature = "alloc")]
// Enum TransactionResultCode: scalar lazy type — impl LazyXdr directly on the enum.
impl LazyXdr for TransactionResultCode {
    ...
    fn xdr_validate(buf: &[u8], _depth: u32) -> Result<u32, Error> {
        ...
        let _ = TransactionResultCode::try_from(v)?;
        Ok(4)
    }
    ...
    fn from_xdr_at(parent: &LazyHandle, offset: u32) -> Self {
        ...
        TransactionResultCode::try_from(v).unwrap()
    }
}
