...
#[cfg(feature = "alloc")]
/// Lazy wrapper for [`ScSpecUdtEnumV0`].
#[derive(Clone, Debug, Hash, PartialEq, Eq)]
pub struct LazyScSpecUdtEnumV0(LazyHandle);
#[cfg(feature = "alloc")]
impl PartialOrd for LazyScSpecUdtEnumV0 {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}
#[cfg(feature = "alloc")]
impl Ord for LazyScSpecUdtEnumV0 {
...
impl LazyXdr for LazyScSpecUdtEnumV0 {
    ...
    fn xdr_len(buf: &[u8]) -> u32 {
        ...
        pos += <LazyVecM<LazyScSpecUdtEnumCaseV0> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        pos
    }
...
#[cfg(feature = "alloc")]
impl From<LazyHandle> for LazyScSpecUdtEnumV0 {
    fn from(h: LazyHandle) -> Self {
        Self(h)
    }
}
#[cfg(feature = "alloc")]
impl AsRef<LazyHandle> for LazyScSpecUdtEnumV0 {
    fn as_ref(&self) -> &LazyHandle {
        &self.0
    }
}
#[cfg(feature = "alloc")]
impl TryFrom<Arc<[u8]>> for LazyScSpecUdtEnumV0 {
    type Error = Error;
...
impl LazyScSpecUdtEnumV0 {
    ...
    /// Access field `cases`.
    #[must_use]
    pub fn cases(&self) -> LazyVecM<LazyScSpecUdtEnumCaseV0> {
        let buf = self.0.as_slice();
        let mut pos: u32 = 0;
        pos += <LazyStringM<1024> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        pos += <LazyStringM<80> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        pos += <LazyStringM<60> as LazyXdr>::xdr_len(&buf[pos as usize..]);
        <LazyVecM<LazyScSpecUdtEnumCaseV0> as LazyXdr>::from_xdr_at(&self.0, pos)
    }
}
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&ScSpecUdtEnumV0> for LazyScSpecUdtEnumV0 {
    type Error = Error;
    fn try_from(val: &ScSpecUdtEnumV0) -> Result<Self, Error> {
        let mut buf = Vec::new();
...
#[cfg(all(feature = "alloc", feature = "std"))]
impl TryFrom<&LazyScSpecUdtEnumV0> for ScSpecUdtEnumV0 {
    type Error = Error;
    fn try_from(lazy: &LazyScSpecUdtEnumV0) -> Result<Self, Error> {
